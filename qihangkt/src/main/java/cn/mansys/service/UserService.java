...
public class UserService {
	...
	public void userPageControl(Model model, int roleId, int page, int pageSize) {
		...
		pageControl(total, model, page, pageSize);
		model.addAttribute("roleId", roleId);
	}

	public void pageControl(int total,Model model,int page,int pageSize) {
		// 获得总页数
