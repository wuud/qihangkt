...
<meta name="mobile-agent"
	content="format=html5;url=https://m.ke.qq.com/course/361593">
<link rel="alternate" media="only screen and (max-width: 640px)"
	href="https://m.ke.qq.com/course/361593">


<meta name="keywords"
	content="Java系列技术之SSM+Bootstrap权限项目实战IT·互联网编程语言Java">
<meta name="description"
	content="带大家用SSM+Bootstrap实战了一下某项目权限控制的部分，对没怎么写过项目的同学，应该会有比较大的收获。"
	itemprop="带大家用SSM+Bootstrap实战了一下某项目权限控制的部分，对没怎么写过项目的同学，应该会有比较大的收获。">
<meta itemprop="name" content="Java系列技术之SSM+Bootstrap权限项目实战" />
<meta itemprop="image"
	content="//10.url.cn/qqcourse_logo_ng/ajNVdqHZLLAu1APYuxsHNpT4jicX0a25aZBUhGrQE5t5B4Wju8VzHWq7BNp0uAx1pVoINW5WhRIU/" />
<meta version="116945" />
<title>${course.cname}</title>

<link rel="canonical" href="https://ke.qq.com/course/361593" />
				...
				<div class="text-right text-right--pay"
					...
					<div class="js-course-price normal-course course-price active"
						...
						<p class="course-price-info ">
							...
							<span class="price " style="float: left">￥ ${course.price }</span>
					...
					<div class="oper-bar" id="js_btn_bar" auto-test="mod_oper_bar">
						<a
							href="${pageContext.request.contextPath}/course/${course.id}/video">
							<span
